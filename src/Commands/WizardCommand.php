...
use Tassili\Tassili\Utils\WizardPart;
...
class WizardCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create Wizard';
    ...
    public function handle()
    {
        ...
        File::copyDirectory(base_path('vendor/tassili/tassili/Fichiers/WizardFiles'), $vueTarget);
